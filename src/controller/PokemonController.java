	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (value1 != null) {
			...
			Bulbasaur b=new Bulbasaur("Bulbasaur",001,"\"\"Bulbasaur is a Grass/Poison-type Pokémon introduced in Generation I. \n" +
					"It evolves into Ivysaur starting at level 16. It is one of the three Starter Pokémon in the Kanto region.\"","POISON","IVYSAUR","64");
			msg = "<center>" + b.getPokemonName() + "  #" + b.getPokemonNumber();
			request.setAttribute("message1", b.getPokemonNumber());
			request.setAttribute("character1", b.getCharacteristics());//getter
		...
		if (value2 != null) {
			// Create the object for Charizard class and use getters to retrieve the values	
			  ...
			  Charizard c= new Charizard("Charizard",006,"\"\"Charizard is fit and strong and has the ability to soar up to ridiculous heights.\n" +
			  		"With a single breath of fire, it can burn down forests and melt gigantic glaciers.\"","FIRE","Charmelon","240");
		...
		if (value3 != null) {
			...
			Dragonite d= new Dragonite("Dragonite",149,"\"\"Dragonite is capable of flying faster than the speed of sound. \n" +
					"It is a kindhearted Pokémon with human-like intelligence. It shows signs of altruism.\"\"","DRAGON","DRATINI","270");
